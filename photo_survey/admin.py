...
class SurveyTemplateAdmin(admin.ModelAdmin):
    ...
    list_editable = ['survey_template_id', 'question_id', 'question_number', 'question_text', 'valid_answers', 'required_by', 'required_by_answer', 'answer_trigger', 'answer_trigger_action']
