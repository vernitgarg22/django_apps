...
if __name__ == "__main__":
    ...
    test_labels = ["tests.test_assessments", "tests.test_cod_utils", "tests.test_commands", "tests.test_photo_survey", "tests.test_waste_schedule", "tests.test_waste_notifier", "tests.test_waste_wizard", "tests.test_weather_info"]
