...
class AssessmentsTests(TestCase):
    ...
    def test_get_sales_address_search_recent_filters_old(self):
        ...
        response = c.get('/assessments/address/7840 VAN DYKE PL/recent/')
        self.assertEqual(response.status_code, 200, "/assessments/<address>/recent/ succeeds")
        expected = {'address': '7840 VAN DYKE PL'}
        self.assertDictEqual(expected, response.data, "/assessments/<address>/recent/ filters out old sales data search results")
    ...
    def test_get_sales_address_search_recent_filters_custom(self):
        ...
        expected = {'address': '7840 VAN DYKE PL'}
        self.assertDictEqual(expected, response.data, "/assessments/<address>/recent/years/<years>/ filters out old sales data search results")
    ...
    def test_get_sales_property_recent_filters_old(self):
        ...
        response = c.get('/assessments/17000074_001/recent/')
        self.assertEqual(response.status_code, 200, "/assessments/<pnum>/recent/ succeeds")
        expected = {'pnum': '17000074.001'}
        self.assertDictEqual(expected, response.data, "/assessments/<pnum>/recent/ filters out out old sales")
    ...
    def test_get_sales_property_recent_filters_custom(self):
        ...
        self.assertEqual(response.status_code, 200, "/assessments/<pnum>/recent/years/<years>/ succeeds")
        expected = {'pnum': '17000074.001'}
        self.assertDictEqual(expected, response.data, "/assessments/<pnum>/recent/years/<years>/ filters out out old sales")
