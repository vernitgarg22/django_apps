...
from cod_utils.messaging import MsgHandler, SlackMsgHandler
...
def subscribe_notifications(request):
    ...
    # MsgHandler(phone_sender_list=[]).send_text(phone_number=phone_number, text="You will receive elections reminders for the address {}".format(address))
